from TPPI.models.TPPP import DL_Shallow_Network, CNN_1D, CNN_2D, CNN_3D, HybridSN, SSAN, pResNet, VGG16, MultiModelCNN
...
# 创新模型
from TPPI.models.NewModels import MultiModelTrans as MultiModelTrans
from TPPI.models.TPPP import HRN as HRN
from TPPI.models.TPPP import NEW
...
def get_model_instance(name):
    try:
        return {
            ...
            'HRN':HRN,
            'MultiModelTrans':MultiModelTrans
        }[name]
    except:
